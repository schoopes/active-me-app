class Api::SendgridController < ApplicationController
  ...
  def confirmation
    ...
    content = Content.new(type: 'text/plain', value: "Hi, #{name}! Congratulations for setting up an account with ActiveMe. Please click this link to confirm your email address and finish setting up your account.")
    mail = Mail.new(from, subject, to, content)
