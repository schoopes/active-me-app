class Api::GoogleController < ApplicationController
  ...
  #   redirect_to "https://accounts.google.com/o/oauth2/auth?scope=https://www.googleapis.com/auth/calendar&redirect_uri=http://localhost:3000/api/google/callback?&response_type=code%20id_token&client_id=172210505146-cglcauiuv08b1rae1pe7a4o4psobdgr6.apps.googleusercontent.com"
  # end
